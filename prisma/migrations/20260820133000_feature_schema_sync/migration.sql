-- Sync schema fields added after initial migrations (automations, settings, analytics, forms).
-- Idempotent — safe on live DBs that already ran db push.
